            ...
            <Main className={classes.root}>
                <Secuence stagger>
                    <article>
                        ...
                        <Fader>
                            <img src={joshMullisFamilyURL.src || joshMullisFamilyURL} alt="Josh Mullis's family" />
                        </Fader>
                        ...
                        <Fader style={{ display: 'block' }}>
                            <Link
                                ...
                                style={{ display: 'block' }}
                            >
                                <img src={newDayFosterHomeURL.src || newDayFosterHomeURL} alt='New Day Forster Home' />
                            </Link>
                        </Fader>
                        <Fader>
                            <blockquote>
                            ...
                            >
                                <img src={newDayFosterHomeLogoURL.src || newDayFosterHomeLogoURL} alt='New Day Foster Home logo' />
                            </Link>
